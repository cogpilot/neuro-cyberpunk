...
public class NeuroEnglishLocalization extends ModLocalizationPackage {
    protected func DefineTexts() -> Void {
        ...
        this.Text("Neuro-NotifyBadConnectionDesc", "The Neuro socket failed to connect five times in a row. Connections will not be retried. Restart the game or use the CET console command Game.GetNeuroSystem().ResetBadConnectionCounter().");
    }
}
